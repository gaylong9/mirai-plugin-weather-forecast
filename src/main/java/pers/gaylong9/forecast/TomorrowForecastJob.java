...
/**Quartz的具体任务类，在此完成明日天气的数据请求与消息发送*/
public class TomorrowForecastJob extends ForecastJob implements Job {

    private final MiraiLogger logger = MiraiLogger.Factory.INSTANCE.create(TomorrowForecastJob.class);
